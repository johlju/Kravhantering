...
Kong är fortsatt en leverantörsavbild och bevakas av
beroendedriftdetektorn. HSA-personuppslagsadaptern och HSA-katalogmocken är
däremot projektägda stödavbildningar och byggs, publiceras, får SBOM och
attesteras av
[trusted container publishing](../development/trusted-container-publishing.md)
med samma release-tags som `app-runtime` och `db-job`. De ska därför inte ingå
i detekteringen av leverantörsavbilder.
